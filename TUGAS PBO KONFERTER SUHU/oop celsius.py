from tkinter import Frame, Label,Entry,Button,Tk, W, E, N, S
...
class FrmSuhu:
    ...
    def aturKomponen(self):
        mainFrame = Frame(self.parent, bd=10, bg='lightgray')
        mainFrame.grid(row=0, column=0, padx=10, pady=10, sticky=N+S+E+W)

        # Judul Program
        Label(mainFrame, text='Konversi Suhu', font=('Helvetica', 16, 'bold'), bg='lightgray').grid(row=1, column=1, columnspan=2, pady=10)
